...
* **Python** cu **Windows OS** ah aa tel chih lo. Cucaah a dang tein **install** tuah a hau. Mah caah cun [www.python.org/downloads/](http://www.python.org/downloads/) in **Python installer** kha **download** tuah a hau.
...
* **Installer** na thim i **download** na tuah dih in, **file** kha hmeh-hnih (**double-clicking**) in tuahter/on. *Figure 2.1* ah langhter mi **dialog** (cakuang) kha screen cung ah a lang lai.  ![Fig 2.1 Python 3.14.1 Installer Screen](../assests/fig%2021.png)
...
* **Python community** chung i **Pythonistas** pawl nih **packages** (**libraries**) an ser i **programmers** dang hman khawh dingin an chiah. An **packages** ṭhenhnak caah **PyPI**—**Python Package Index** ([www.pypi.org](http://www.pypi.org)) an hmang.
...
* Nangmah zong **PyPI** ah register na tuah kho i na **packages** pawl na upload khawh ve. **Package** ser ning, build tuah ning le **Python Package Index** ah upload tuah ning kong he pehtlai in [www.pypi.org](http://www.pypi.org) ah lam hmuhsaknak an pek mi na zulh a hau.
...
```python title="Check Python Version"
import sys
print(sys.version)
```
...
|g.`Pandas`|7. **Code** le **visualization** tial ṭi nak document sernak.|
|h.`MatPlotlib`|8. **Scientific computing library** a si.|
|i.`OpenCV`|9.**Third-party packages** ṭhenhnak hmun.|
...
| b. `Jupyter` | **7. Build and document applications** | **Code** le **visualization** tial ṭi nak document sernak. |
| c. `Spyder` | **2. Scientific Computing** | **Scientific Python Development Environment** a si caah *Scientific Computing* he aa tlak bik. |
| d. `PyPI` | **9. Python Package index** | **Third-party packages** ṭhenhnak hmun. |
